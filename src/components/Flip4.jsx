...
import vtest2 from '../assets/mobileCarousel2.png'
...
const Flip4 = () => {
    ...
    if(showPicture){
        return(
            ...
            >
                <img src={vtest2} alt='biobee' className='rounded-[30px]' onClick={toggleCard} />
          ...
          return (
            ...
            className='text-white relative flex items-center w-full h-full text-center'>
                <img src={vtest2} alt='biobeeback' className='rounded-[30px]' />
